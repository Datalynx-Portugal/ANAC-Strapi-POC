...
export default function ProductDetailTwo({data}){
            ...
            <div className="row align-items-center">
                <div className="col-md-5">
                    <div className="tiny-single-item">
                        <TinySlider settings={settings}>
                            <div className="tiny-slide"><Image src={data?.image1} width={0} height={0} sizes="100vw" style={{width:'100%', height:'auto'}} className="img-fluid rounded" alt=""/></div>
                            <div className="tiny-slide"><Image src={data?.image2} width={0} height={0} sizes="100vw" style={{width:'100%', height:'auto'}} className="img-fluid rounded" alt=""/></div>
                        </TinySlider>   
                    </div>
                </div>
                ...
                <div className="col-md-7 mt-4 mt-sm-0 pt-2 pt-sm-0">
                    <div className="section-title ms-md-4">
                        <h4 className="title">{data?.product}</h4>
